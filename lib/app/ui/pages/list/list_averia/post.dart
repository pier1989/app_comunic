import 'package:app_comunic/app/data/data/database.dart';
...
class Viewdata extends StatefulWidget {
  Viewdata({required Key key, required this.country, required this.db})
      : super(key: key);
  Map country;
  Database db;
  @override
...
class _ViewState extends State<Viewdata> {
